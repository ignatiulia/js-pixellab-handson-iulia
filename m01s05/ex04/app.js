var calculateRectangleArea = (width, length) => {
  return width * length;
};
...
const aggregateSurfaceArea = (l1, w1, l2, w2) => {
  const surfaceArea1 = calculateRectangleArea(l1, w1);
  const surfaceArea2 = calculateRectangleArea(l2, w2);
...
newSurface = aggregateSurfaceArea(48, 92, 51, 102);
