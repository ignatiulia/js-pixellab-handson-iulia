...
var message = '';
person.friends.forEach(function (friend) {
  var diff = friend.age - person.age;
...
console.warn(`
Folosind metoda reverse (+slice) si apoi forEach, afiseaza in ordine inversa numele complet al prietenilor din arrayul friends.
`);
